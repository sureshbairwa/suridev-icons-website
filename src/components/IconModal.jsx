...
const IconModal = ({ icon, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white p-6 rounded-lg w-[500px] max-w-lg relative text-center">
        ...
        <div className="flex items-center justify-center w-32 h-32 mx-auto mb-2 bg-slate-300 rounded-xl">
          {React.cloneElement(icon.component, { height: 90, width: 90 })}
        </div>
  ...
  <span className="relative group">
    ...
    <pre className="bg-black text-white w-full p-4 rounded-b m-0 cursor-pointer " 
